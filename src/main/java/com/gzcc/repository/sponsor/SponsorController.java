package com.gzcc.repository.sponsor;
...
public class SponsorController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "activityUid",value = "活动id",dataType = "String")
    })
    @PostMapping("activities/signIn")
    public ResponseEntity<String> SignInCode(
            @RequestParam(required = false,name = "studentId") String studentId,
            @RequestParam(required = false,name = "activityUid") String activityUid
    ){
...
//        QRCodeUtil.encode(text, imgPath, destPath, true);
        if("success".equals(activityService.sginIn(studentId,activityUid))){
